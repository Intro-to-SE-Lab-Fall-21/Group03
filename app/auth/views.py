from flask import Blueprint,session,g,request, current_app,make_response, render_template, flash, redirect, url_for,make_response
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user.check_password(password):
            flash("You are successfully loggged in.", "success")
            login_user(user)
...
def encrypt_cookie(content):
    ...
    encryted_content = s.dumps(content)
    return encryted_content
